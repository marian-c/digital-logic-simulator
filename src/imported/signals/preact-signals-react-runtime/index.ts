// FROM https://github.com/preactjs/signals/blob/main/packages/react/runtime/src/index.ts
...
export function _useSignalsImplementation(_usage: EffectStoreUsage = UNMANAGED): EffectStore {
  ...
  const storeRef = useRef<EffectStore>(null);
...
export function useSignal<T>(value?: T, options?: SignalOptions<T>) {
  return useMemo(() => signal<T | undefined>(value, options as SignalOptions), Empty);
}
