...
function handleCustomBox(
  ...
  // supportData.simulation.boxSimState = [];
  // supportData.simulation.connectorSimState = [];
  // const innerSimulation = { boxSimState: [], connectorSimState: [] };

  // const newSimulationData: SimulationData = {
  //   structure: customSketch.structure,
  //   inputs: {
  //     inputsState: inputs,
  //   },
