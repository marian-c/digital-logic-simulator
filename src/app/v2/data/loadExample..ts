...
export const exampleSketches: Sketch[] = [
  { structure: structure1, meta: meta1, state: state1, inputs: inputs1, positions: positions1 },
  { structure: structure2, meta: meta2, state: state2, inputs: inputs2, positions: positions2 },
  { structure: structure3, meta: meta3, state: state3, inputs: inputs3, positions: positions3 },
];
